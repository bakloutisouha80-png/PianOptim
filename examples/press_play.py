...
def prepare_ocp(
    ...
    objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="tau", phase=1, weight=0.001)
    # objective_functions.add(
    #     ObjectiveFcn.Lagrange.MINIMIZE_MARKERS_VELOCITY, marker_index="contact_finger", phase=1, weight=0.001
    # )
    objective_functions.add(ObjectiveFcn.Lagrange.MINIMIZE_CONTROL, key="tau", phase=2, weight=0.001)
